...
class ComposerAutoloaderInitc07dc2637b893a4b7df6db5f8b4c0d8d
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitc07dc2637b893a4b7df6db5f8b4c0d8d::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequirec07dc2637b893a4b7df6db5f8b4c0d8d($fileIdentifier, $file);
        }
...
function composerRequirec07dc2637b893a4b7df6db5f8b4c0d8d($fileIdentifier, $file)
{
